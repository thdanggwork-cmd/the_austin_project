...
An interactive, terminal-based CLI application engineered to bypass awkward remote roommate small talk, streamline boarding logistics, and stress-test the user's input boundaries.
...
---
## 👨‍🦲 User Registration:
When the program asks for your name, type Austin, or austin, or whatever aUStiN things. Just need to be Austin (you only have two lives for this!). Then, proceed with the manual from the code itself!
