...
---
## 👨‍🦲 User Registration:
When the program asks for your name, type Austin, or austin, or whatever aUStiN things. Just need to be Austin
(you only have two lives for this!)
Then, proceed with the manual from the code itself!
